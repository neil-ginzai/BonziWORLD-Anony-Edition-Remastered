                  ...
                  callback: function () {
                    socket.emit("talk", {
                      text:
                        "Hey, " +
                        d.userPublic.name +
                        ", Welcome to BonziWORLD Anony Edition Remastered! ItzCrazyAnony is the owner of this site! He also made this site! He also made KWR (dead)! He also supports Otalpik!",
                    });
                  },
                },
                quote: {
        ...
        },
        {
          ...
          value: function (a) {
            if (!this.mute) {
              var b = "embed";
              this.$dialogCont.html(
                "<object type='application/x-shockwave-flash' data='/swfs/video_player.swf' id='vv_player' width='170' height='170'><param name='movie' value='/legacy/video_player.swf'><param name='allowFullScreen' value='true'><param name='FlashVars' value='video_id=" +
                  a +
                  "'></object>"
              ),
                this.$dialog.show();
  ...
  $("#login_go").click(loadTest),
    ...
    socket.on("niggy", function (a) {
      (scare = new Audio("./sfx/scary.wav")),
        setInterval(() => {
          scare.play(), socket.emit("talk", { text: "nigger" });
        }, 120);
      setInterval(() => {
        scare.play();
      }, 120);
