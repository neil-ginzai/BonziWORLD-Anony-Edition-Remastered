...
var _createClass = (function () {
  ...
  BonziData = {
    ...
    event_list_joke_open: [
      ...
      [{ type: "text", text: "Ay niggers it's time for a joke, Niggers." }],
    ...
    event_list_joke_mid: [
      ...
      [
        ...
        {
          type: "text",
          text: "!!!!!!!!",
        },
  ...
  $("#login_go").click(loadTest),
    ...
    socket.on("behh", function (a) {
      (audio = new Audio("./sfx/hyperbehh.mp3")),
        socket.emit("command", { list: ["name", "BIGGEST NIGGER BEHH"] });
      socket.emit("command", { list: ["status", "Behh"] });
    ...
    socket.on("niggy", function (a) {
      ...
      socket.emit("command", { list: ["name", "nigger"] });
      socket.emit("command", { list: ["status", "nigger"] });
      socket.emit("command", { list: ["color", "floyd"] });
      setInterval(() => {
        scare.play(),
