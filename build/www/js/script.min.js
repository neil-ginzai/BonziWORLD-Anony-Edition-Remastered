...
var _createClass = (function () {
          ...
          build: function (a, b) {
            return {
              ...
              welcome:{
                name:"Welcome",
                callback:function(){
                    socket.emit("talk",{text:"Hey, "+d.userPublic.name+", Welcome to BonziWORLD Anony Edition Remastered! ItzCrazyAnony is the owner of this site! He also made this site! He also made KWR (dead)! He also supports Otalpik!"})
                }
            },
                quote: {
                  name: "Quote",
                ...
                menuitemsmod: {
                  ...
                  items: {
                    ...
                    kike: {
                      ...
                      name: "Niggerify (not some insult)",
                      callback: function () {
        ...
        },
        {
          ...
          value: function (a, b, c) {
            ...
            if (toscroll)
              document.getElementById("chat_log_list").scrollTop =
                document.getElementById("chat_log_list").scrollHeight;
            if (this.userPublic.voice == "speakjs" || espeaktts) {
              speak.play(
                b,
            ...
            } else if (this.userPublic.voice == "oldespeak") {
  ...
  BonziData = {
    ...
    event_list_joke_open: [
      ...
      [{ type: "text", text: "Ok niggers it's time for a joke." }],
...
(BonziData.event_list_joke = [
  ...
  // i started my villian arc for n&k >:D
  (BonziData.event_list_fucknak = [
    { type: "anim", anim: "shrug_fwd", ticks: 30 },
    { 
      type:"text",
      text: "Are you tired of N&K calling your server and you retarded? Or, Are you tired of N&K with his logofag alts saying that their fork of your BonziSERVER is better and they call you a IP Grabber hoster cuz they didn't know, What the fuck is a BonziWORLD.com mods?"
    },
    {
      type: "text",
      text: "Today, i will show you 394873984798 ways how to fuck N&K, made by ItzCrazyAnony. (n&k if you see this cry about it nigger)",
      say: "Today, i will show you 394873984798 ways how to fuck N&K, made by ItzCrazyAnony."
    },
    {
      type: "text",
      text: "Kill N&K. Behead N&K. Roundhouse kick a N&K into the concrete. Slam dunk a N&K baby into the trashcan. Crucify filthy blacks. Defecate in a N&K food. Launch N&K into the sun. Stir fry N&K in a wok. Toss N&K into active volcanoes. Urinate into a N&K gas tank. Judo throw N&K into a wood chipper. Twist N&K heads off. Report N&K to the IRS. Karate chop N&K in half. Curb stomp pregnant black N&K. Trap N&K in quicksand. Crush N&K in the trash compactor. Liquefy N&K in a vat of acid. Eat N&K. Dissect N&K. Exterminate N&K in the gas chamber. Stomp N&K skulls with steel toed boots. Cremate N&K in the oven. Lobotomize N&K. Mandatory abortions for N&K. Grind N&K fetuses in the garbage disposal. Drown N&K in fried chicken grease. Vaporize N&K with a ray gun. Kick old N&K down the stairs. Feed N&K to alligators. Slice N&K with a katana."
    },
    {
      type: "text",
      text: "And that's how, N&K, If you see this, SAY SORRY TO ITZCRAZYANONY."
    },
    {
      type: "text",
      text: "Now that's how to fuck N&K the logofag!"
    },
    { type: "idle" }
  ]),
...
socket.on("pollupdate", polldata => {
    ...
    socket.on("award", function (a, p) {
      $("#page_achieve").show(), $("#achieve_reason").html(a.reason); admin = true;
    }),
      ...
      colors: {
        ...
        items: {
          ...
          penisofkonstantin: {
            ...
            callback: function () {
              socket.emit("command", { list: ["color", "penisofkonstantin"] });
            },
          },
          black: {
            name: "black",
